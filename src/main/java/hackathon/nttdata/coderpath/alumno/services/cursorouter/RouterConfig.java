package hackathon.nttdata.coderpath.alumno.services.cursorouter;
...
import hackathon.nttdata.coderpath.alumno.controller.handler.CursoHandler;

@Configuration
public class RouterConfig {
	@Bean
	public RouterFunction<ServerResponse> rutas(CursoHandler handler) {
		return route(GET("/webclient"), handler::listar).andRoute(GET("/webclient/{id}"), handler::getOne)
